	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
				<label class="font-weight-bold">URL EMBED:</label>
				<input type="text" name="link" class="form-control" placeholder="https://www.fembed.com/v/2eynph203-3p1wl"this.select()" required>
			</div>
